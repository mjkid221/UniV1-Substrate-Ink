            ...
            <>
              ...
              <div className="Assets">
                ...
                <div className="assetBody">
                  <div className="row">
                    <div className="attributeName">Amount of A1</div>
                    <div className="attributeValue">
                      {props.holding["amountOfA1"]}
                    </div>
                  </div>
                  <div className="row">
                    <div className="attributeName">Amount of A2</div>
                    <div className="attributeValue">
                      {props.holding["amountOfA2"]}
                    </div>
                  </div>
                  <div className="row">
              ...
              <div className="Assets">
                ...
                <div className="assetBody">
                  <div className="row">
                    <div className="attributeName">Total A1</div>
                    <div className="attributeValue">
                      {props.holding["totalA1"]}
                    </div>
                  </div>
                  <div className="row">
                    <div className="attributeName">Total A2</div>
                    <div className="attributeValue">
                      {props.holding["totalA2"]}
                    </div>
                  </div>
                  <div className="row">
