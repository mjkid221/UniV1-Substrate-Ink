...
export default function SwapComponent(props) {
  const [coin, setCoin] = useState(["A1", "A2"]);
        ...
        if (coin[0] === "A1") {
          await props.contract.query
            .swapToken1GivenToken1(
              ...
              parseInt(((amountTo * (100 - slippageTolerance)) / 100) * PRECISION)
            )
            .then((res) => {
  ...
  return (
    <div className="tabBody">
      ...
      <BoxTemplate
        ...
        balance={
          props.holding[
            "amountOfA1".includes(coin[0]) ? "amountOfA1" : "amountOfA2"
          ]
        }
      ...
      <BoxTemplate
        ...
        balance={
          props.holding[
            "amountOfA1".includes(coin[1]) ? "amountOfA1" : "amountOfA2"
          ]
        }
